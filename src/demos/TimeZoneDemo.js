...
export default class extends Demo {
  ...
  init(controlEl, contentEl, calendarEl) {
    ...
    let calendar = new Calendar(calendarEl, {
      ...
      events: '{{ site.parent_baseurl }}/api/demo-feeds/events.json', // TODO: use BASE_URL
    ...
    requestJson('GET', '{{ site.parent_baseurl }}/api/demo-feeds/timezones.json', {}, function(timeZones) { // TODO: use BASE_URL
