---
title: V7 Upgrade Guide for Custom CSS
layout: text
---
...
This only applies to you if starting from v5 or v6.
...
The v6 DOM structure and CSS made if difficult to remove the calendar view's outer border. You may have relied on table-related hacks:
...
Those won't work anymore. There's now an easier way to do it:
...
.fc-daygrid-day-frame          ⛔  /* no equivalent. was inner-wrap for fc-daygrid-day */
...
Resource-Timeline, with datagrid:
...
.fc-datagrid-expander-placeholder  ➡️  .fc-datagrid-indent .fc-icon:last-child:not(.fc-datagrid-expander)
```
...
- [Data Attribute Changes](#data-attribute-changes)
- [Class-Names Changes](#class-names-changes)
  - [Theme](#theme)
  - [Toolbar](#toolbar)
  - [View Container](#view-container)
  - [Events](#events)
  - [DayGrid & TimeGrid Header](#daygrid--timegrid-header)
