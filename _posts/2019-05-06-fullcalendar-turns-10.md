...
<img src='{{ site.baseurl }}/assets/images/10-year/yc.svg' alt='Y Combinator logo' width='200' height='200' class='float-image' style='margin: 0 -125px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/ga.png' alt='traffic graph' width='650' height='187' class='indented' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/hustle-and-bustle.jpg' alt='crazy work' width='350' height='258' class='float-image' style='margin: 0 -255px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/momentjs.png' alt='MomentJS logo' width='300' height='124' class='float-image' style='margin: 0 -225px 40px 40px' />
<img src='{{ site.baseurl }}/assets/images/10-year/karma.png' alt='Karma logo' width='300' height='70' class='float-image' style='margin: 40px -225px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/newsite.png' alt='website screenshot' width='350' height='366' class='float-image' style='margin: 0 -255px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/shut-up.jpg' alt='comic' width='350' height='219' class='float-image' style='margin: 0 -255px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/beer.jpg' alt='chugging beer' width='350' height='263' class='float-image' style='margin: 0 -255px 40px 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/react.svg' alt='React logo' width='275' height='194' class='float-image' style='margin:-20px -163px 0 -20px' />
<img src='{{ site.baseurl }}/assets/images/10-year/vue.png' alt='Vue logo' width='160' height='160' class='float-image' style='margin:0 -105px 0 40px' />
<img src='{{ site.baseurl }}/assets/images/10-year/angular.svg' alt='Angular logo' width='200' height='200' class='float-image' style='margin:0 -125px 0 40px' />
...
<img src='{{ site.baseurl }}/assets/images/10-year/cake.jpg' alt='birthday cake' width='400' height='300' />
