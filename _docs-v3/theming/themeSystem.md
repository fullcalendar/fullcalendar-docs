...
`'bootstrap3'`
: Prepares the calendar for a [Bootstrap 3](https://getbootstrap.com/docs/3.3/) theme. The Bootstrap CSS file must be separately loaded in its own `<link>` tag. [See a demo](bootstrap3-theme-demo).
